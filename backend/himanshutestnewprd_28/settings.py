"""
Django settings for himanshutestnewprd_28 project.
...
ROOT_URLCONF = 'himanshutestnewprd_28.urls'
...
WSGI_APPLICATION = 'himanshutestnewprd_28.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutestnewprd_28 API",
    "DESCRIPTION": "API documentation for himanshutestnewprd_28 App",
    "VERSION": "v1",
}
